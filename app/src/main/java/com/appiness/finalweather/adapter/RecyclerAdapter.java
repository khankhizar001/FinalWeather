package com.appiness.finalweather.adapter;
...
import com.appiness.finalweather.utils.Utility;
...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.DayViewHolder> {
    ...
    public RecyclerAdapter(Context context, List<Weather> days, View.OnClickListener clickListener) {
    ...
    public DayViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 0) {
            v = LayoutInflater.from(viewGroup.getContext())
                    .inflate(R.layout.recycler_item_current_day, viewGroup, false);
    ...
    public void onBindViewHolder(DayViewHolder dayViewHolder, int i) {
        ...
        if (unitType.equals(context.getString(R.string.pref_units_metric))) {
            dayViewHolder.tempMin.setText(String.format("%.0f", Utility.convertFahrenheitToCelcius(days.get(i).getTempMax())).concat("\u00B0"));
            dayViewHolder.tempMin.setText(String.format("%.0f",Utility.convertFahrenheitToCelcius(days.get(i).getTempMin())).concat("\u00B0"));
        }
        else {
